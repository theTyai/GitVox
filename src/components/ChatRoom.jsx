...
// Pass credentials: true so cookies are sent for auth handshake
    ...
    <div className="flex-1 bg-gray-800 rounded border border-gray-700 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.map((m, i) => (
          <div key={i} className="flex gap-3">
             <img src={m.sender.avatarUrl} className="w-8 h-8 rounded-full" alt="" />
             <div>
      ...
      <div className="p-3 border-t border-gray-700">
        <input 
          ...
          className="w-full bg-gray-900 border border-gray-600 rounded px-3 py-2 text-white focus:outline-none"
        />
      </div>
    </div>
  );
